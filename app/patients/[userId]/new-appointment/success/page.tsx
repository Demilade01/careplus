      ...
      <div className='success-img'>
        ...
        <section className='flex flex-col items-center'>
          ...
          <h2 className='header mb-6 max-w-[600px] text-center text-white'>
            Your <span className='text-green-500'>appointment request</span> has been successfully booked.
          </h2>

          <p className='text-gray-400'>We will be in touch, to confirm shortly.</p>
        </section>
